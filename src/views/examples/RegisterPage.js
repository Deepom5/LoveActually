        ...
        <h1 className="title"><strong>Events</strong></h1><br/>
          ...
          <Card>
            ...
            <CardBody>
              ...
              <br/>
              <CardText style={{color:"black"}}>It is our signature activity where we push inclusivity by pulling together able and disabled people and exhibit the best skills in performing arts.It is an activity by PWDs for PWDs, the idea is to bring a new perspective among able people when they encounter PWDs.</CardText>
          ...
          <Card>
            ...
            <CardBody>
              ...
              <br/>
              <CardText style={{color:"black"}}>First offline activity, an evening with PWDs in Delhi during Diwali 2019, where talented disabled performers gave a glimpse of their talent in an open environment and shared the stage with able performers More than 3k+ crowd cheering for them was an overwhelming experience. Impact - People started knowing the performers, one started her podcast, and a few gained more recognition </CardText>
          ...
          <CardBody>
            ...
            <CardText style={{color:"black"}}>Upcoming</CardText>
